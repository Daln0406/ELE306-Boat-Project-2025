...
%% ---------- PARAMETRE ----------
dt               = 0.005;       % tidssteg [s] sett 0.005 for "smoothere" visualisering i Gazebo 
snake_speed      = 0.5;        % fremdrift [m/s] (konstant i denne modellen)
plot_update_sec  = 0.005;       % plott hvert 0.05 s
...
while t < max_time
   ...
   % ---------- STYRING + KINEMATIKK ----------
    ...
    switch mode
        ...
        case "pick"
            % 1) Ny kameramåling – fortsatt fake
